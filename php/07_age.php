...
$sql = "SELECT gender, AVG(YEAR(CURRENT_DATE) - YEAR(birth_date)) as avg_age FROM users GROUP BY gender";
    ...
    <div>
        <?php
            foreach ($result as $user) {
                ...
                echo $user['gender'] . " : Moyenne d'âge : ~" . round($user['avg_age'], 0) . "ans<br>";
            }
        ?>
    </div>
</body>
